      ...
      <View className="w-full " style={styles.container}>
        ...
        <View className="flex flex-row items-center mx-2">
          <View className="my-4  px-6 flex-1 ">
            ...
            <View className="h-10 w-[2px] bg-gray-400 mx-5"></View>
            <View className="border border-[#A0A1B0] rounded-lg h-14 flex flex-row items-center px-2 gap-x-1">
          ...
          <View className="rotate-90 ">
            <AntDesign name="swap" size={34} color="#424256" />
          </View>
        </View>
        <Pressable className="mx-6 rounded-full my-2 border flex-row flex border-[#EBEBEF] item-center p-2 w-[150px]">
          <Ionicons name="image-outline" size={30} color="#40B876" />
          <Text className="text-2xl text-[#121337]">Use map</Text>
        </Pressable>
      </View>
      <View className="my-3  w-full">
        <View className="mx-6">
          <Text className="text-[#0B0C23] text-xl">Recent locations</Text>
        </View>
        <ScreenContainer>
          <View className="my-4">

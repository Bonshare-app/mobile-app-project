...
const YourDestinationMap = ({ navigation }) => {
  return (
    <View className="h-full ">
        ...
        <View className="px-4" style={styles.container}>
          <View className="space-y-2">
            <Text className="text-[#0B0C23] font-semibold text-2xl">
              Where in Ankara would you like to drop off your passengers?
            </Text>
      ...
      <ScreenContainer>
        ...
        <View className="my-4 w-full flex flex-row items-center justify-center">
          <View className="w-[90%]">
            <Button label={"Next"} isMain={false} onPress={()=>navigation.navigate('routes')}/>
          </View>
        </View>
      </ScreenContainer>
    </View>
...
export default YourDestinationMap;
